 ...
 * @author Edwin Rafael
 */
public class MInformacionCorreo extends javax.swing.JFrame {

    /**
     * Creates new form MInformacionCorreo
     */
    public MInformacionCorreo() {
    ...
    private void initComponents() {
        ...
        rSPanelOpacity1.setBackground(new java.awt.Color(0, 153, 204));
        ...
        rSLabelIcon1.setIcons(rojeru_san.efectos.ValoresEnum.ICONS.INFO);
        rSPanelOpacity1.add(rSLabelIcon1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 80, 150, 140));
        ...
        jLabel7.setText("correo, revise la bandeja de entrada.");
        rSPanelOpacity1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 290, 440, -1));
        ...
        rSPanelOpacity1.add(rSButtonRound1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 330, -1, -1));

        jLabel8.setBackground(new java.awt.Color(255, 255, 255));
        jLabel8.setFont(new java.awt.Font("Franklin Gothic Book", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel8.setText("Si ha ingresado un correo asociado a nuestros registros, se");
        rSPanelOpacity1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 230, 440, -1));

        jLabel9.setBackground(new java.awt.Color(255, 255, 255));
        jLabel9.setFont(new java.awt.Font("Franklin Gothic Book", 1, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel9.setText("le debió haber enviado el código de recuperación al mismo");
        rSPanelOpacity1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 260, 440, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MInformacionCorreo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MInformacionCorreo().setVisible(true);
            }
        });
    }
