 ...
 * @author Edwin Rafael
 */
public class AvisoFacturaConRTN extends javax.swing.JFrame {
  ...
  VerificarOrdenADomicilio vod=null;
    ...
    private void initComponents() {
        ...
        rSPanelOpacity1.add(rSButtonRound1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 240, 140, -1));

        jLabel8.setBackground(new java.awt.Color(255, 255, 255));
        jLabel8.setFont(new java.awt.Font("Franklin Gothic Book", 2, 24)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel8.setText("¿DESEA LA FACTURA CON RTN?");
        ...
        rSPanelOpacity1.add(rSButtonRound2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 240, 140, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AvisoFacturaConRTN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AvisoFacturaConRTN().setVisible(true);
            }
        });
    }
