...
public class VentanaEmergente2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("CONTRASEÑA ACTUALIZADA ");
        ...
        rSPanelOpacity1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 100, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaEmergente2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaEmergente2().setVisible(true);
            }
        });
    }
