 ...
 * @author Edwin Rafael
 */
public class ErrorToken extends javax.swing.JFrame {
    ...
    public void error(){
        if(tipo=="ET"){
            ...
            jLabel7.setText("TOKEN INCORRECTO");
    ...
    private void initComponents() {
        ...
        rSPanelOpacity1.setBackground(new java.awt.Color(204, 0, 51));
        ...
        rSLabelIcon1.setIcons(rojeru_san.efectos.ValoresEnum.ICONS.PHONELINK_LOCK);
        rSPanelOpacity1.add(rSLabelIcon1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 180, 150, 140));

        jLabel6.setBackground(new java.awt.Color(255, 255, 255));
        jLabel6.setFont(new java.awt.Font("Franklin Gothic Medium", 1, 40)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("NO HAY TOKENS ASOCIADOS");
        rSPanelOpacity1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, 550, -1));

        jLabel7.setBackground(new java.awt.Color(255, 255, 255));
        jLabel7.setFont(new java.awt.Font("Franklin Gothic Book", 0, 36)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel7.setText("AL CORREO INGRESADO");
        rSPanelOpacity1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 120, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErrorToken.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ErrorToken().setVisible(true);
            }
        });
    }
